    ...
    if (showPasswordDialog) {
        PasswordChangeDialog(
            ...
            onPasswordChange = { newPassword ->
                // For this implementation, we'll use an empty current password
                // since the PasswordChangeDialog in the comps file only takes a single password parameter
        ...
        Column(
            ...
            SettingsSection(title = "Notifications") {
                SettingsItem(
                    ...
                    subtitle = "Get notified about tasks",
                    action = {
                        Switch(
                ...
                if (state.pushNotificationsEnabled) {
                    SettingsItem(
                        ...
                        subtitle = "Warns you when missing tasks",
                        action = {
                            Switch(
